    ...
    return (
        <BrowserRouter basename="/">
            <nav className="w-full flex md:justify-center justify-between items-center p-4">
                ...
                {/* Una lista de enlaces a las diferentes secciones de la página. */}
                ...
                <div className="flex relative">
                    {/* Un operador ternario que comprueba si el menú está abierto o no. Si está abierto, mostrará el ícono
                    de cerrar, si no, mostrará el ícono de menú. */}
                    {toggleMenu ?
                    ...
                    {/* Es una interpretación condicional. Si toggleMenu es verdadero, representará el elemento ul. */}
